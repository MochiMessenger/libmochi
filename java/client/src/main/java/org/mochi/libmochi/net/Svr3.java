 ...
 *
 * <p>Its instance can be obtained from an {@link org.mochi.libmochi.net.Network#svr3()} property
 * of the {@link org.mochi.libmochi.net.Network} class.
 *
 * <p>Example usage:
 *
 * <pre>{@code
 ...
 * org.mochi.libmochi.internal.CompletableFuture}s and do not throw any exceptions themselves. The
...
public final class Svr3 {
   ...
   * @param auth an instance of {@link org.mochi.libmochi.net.EnclaveAuth} containing the username
   ...
   * @return an instance of {@link org.mochi.libmochi.internal.CompletableFuture} which-when
   ...
   *     secret.
   * @throws {@link org.mochi.libmochi.net.NetworkException} in case of network connection errors,
   *     like connect timeout.
   * @throws {@link org.mochi.libmochi.net.NetworkProtocolException} more specifically in cases
   ...
   * @throws {@link org.mochi.libmochi.attest.AttestationDataException} when the server
   *     attestation document is malformed or incomplete.
   * @throws {@link org.mochi.libmochi.attest.AttestationFailedException} when an attempt to
   *     validate the server attestation document fails.
   * @throws {@link org.mochi.libmochi.sgxsession.SgxCommunicationFailureException} when a Noise
   ...
   * org.mochi.libmochi.net.NetworkException} should be retried (even though there are multiple
   ...
   *     when connection cannot be established on a higher level of the network stack. For example,
   *     receiving an error HTTP status code.
   * @throws {@link org.mochi.libmochi.svr.DataMissingException} when the maximum restore attempts
   *     number has been exceeded or if the value has never been backed up.
   * @throws {@link org.mochi.libmochi.svr.RestoreFailedException} when the combination of the
   *     password and masked share set does not result in successful restoration of the secret.
   * @throws {@link org.mochi.libmochi.svr.SvrException} when the de-serialization of a masked
   ...
   *     for about 15 minutes, therefore it can be reused for the subsequent calls to either backup
   *     or restore that are not too far apart in time.
   * @return an instance of {@link org.mochi.libmochi.internal.CompletableFuture} successful
