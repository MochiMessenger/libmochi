...
public interface SenderKeyStore {
  ...
  /**
   * Commit to storage the {@link org.mochi.libmochi.protocol.groups.state.SenderKeyRecord} for a
  ...
  /**
   * Returns a copy of the {@link org.mochi.libmochi.protocol.groups.state.SenderKeyRecord}
