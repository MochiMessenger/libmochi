...
import org.mochi.libmochi.protocol.groups.state.InMemorySenderKeyStore;
import org.mochi.libmochi.protocol.groups.state.SenderKeyRecord;
...
public class InMemoryMochiProtocolStore implements MochiProtocolStore {
  ...
  public InMemoryMochiProtocolStore(IdentityKeyPair identityKeyPair, int registrationId) {
  ...
  @Override
  public SessionRecord loadSession(MochiProtocolAddress address) {
    return sessionStore.loadSession(address);
  }

  @Override
  public List<SessionRecord> loadExistingSessions(List<MochiProtocolAddress> addresses)
  ...
  @Override
  public void storeSession(MochiProtocolAddress address, SessionRecord record) {
    sessionStore.storeSession(address, record);
  }

  @Override
  public boolean containsSession(MochiProtocolAddress address) {
    return sessionStore.containsSession(address);
  }

  @Override
  public void deleteSession(MochiProtocolAddress address) {
