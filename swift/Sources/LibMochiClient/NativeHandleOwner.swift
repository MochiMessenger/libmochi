...
public class NativeHandleOwner {
    ...
    internal class func destroyNativeHandle(_: OpaquePointer) -> MochiFfiErrorRef? {
...
public class ClonableHandleOwner: NativeHandleOwner {
    ...
    internal class func cloneNativeHandle(_ newHandle: inout OpaquePointer?, currentHandle: OpaquePointer?) -> MochiFfiErrorRef? {
        fatalError("must be implemented by subclasses")
    }
}
