...
package org.mochi.libmochi.internal;
...
import org.mochi.libmochi.protocol.logging.Log;
...
public final class Native {
  ...
  /*
  If libmochi_jni is embedded within this jar as a resource file, attempt
  ...
  */
  ...
  public static native byte[] IdentityKeyPair_MochiternateIdentity(long publicKey, long privateKey, long otherIdentity) throws Exception;
  ...
  public static native long PreKeyMochiMessage_Deserialize(byte[] data) throws Exception;
  public static native void PreKeyMochiMessage_Destroy(long handle);
  public static native long PreKeyMochiMessage_GetBaseKey(long m);
  public static native long PreKeyMochiMessage_GetIdentityKey(long m);
  public static native int PreKeyMochiMessage_GetPreKeyId(long obj) throws Exception;
  public static native int PreKeyMochiMessage_GetRegistrationId(long obj) throws Exception;
  public static native byte[] PreKeyMochiMessage_GetSerialized(long obj) throws Exception;
  public static native long PreKeyMochiMessage_GetMochiMessage(long m);
  public static native int PreKeyMochiMessage_GetSignedPreKeyId(long obj) throws Exception;
  public static native int PreKeyMochiMessage_GetVersion(long obj) throws Exception;
  public static native long PreKeyMochiMessage_New(int messageVersion, int registrationId, int preKeyId, int signedPreKeyId, long baseKey, long identityKey, long mochiMessage) throws Exception;
  ...
  public static native byte[] SessionCipher_DecryptPreKeyMochiMessage(long message, long protocolAddress, SessionStore sessionStore, IdentityKeyStore identityKeyStore, PreKeyStore prekeyStore, SignedPreKeyStore signedPrekeyStore, KyberPreKeyStore kyberPrekeyStore) throws Exception;
  public static native byte[] SessionCipher_DecryptMochiMessage(long message, long protocolAddress, SessionStore sessionStore, IdentityKeyStore identityKeyStore) throws Exception;
  ...
  public static native void MochiMedia_CheckAvailable();

  public static native long MochiMessage_Deserialize(byte[] data) throws Exception;
  public static native void MochiMessage_Destroy(long handle);
  public static native byte[] MochiMessage_GetBody(long obj) throws Exception;
  public static native int MochiMessage_GetCounter(long obj) throws Exception;
  public static native int MochiMessage_GetMessageVersion(long obj) throws Exception;
  public static native long MochiMessage_GetSenderRatchetKey(long m);
  public static native byte[] MochiMessage_GetSerialized(long obj) throws Exception;
  public static native long MochiMessage_New(int messageVersion, byte[] macKey, long senderRatchetKey, int counter, int previousCounter, byte[] ciphertext, long senderIdentityKey, long receiverIdentityKey) throws Exception;
  public static native boolean MochiMessage_VerifyMac(long msg, long senderIdentityKey, long receiverIdentityKey, byte[] macKey) throws Exception;
