...
#[test]
fn aes_ctr_smoke_test() -> Result<(), mochi_crypto::Error> {
    ...
    let mut aes_ctr = mochi_crypto::Aes256Ctr32::from_key(&key, &nonce, init_ctr)?;
...
#[test]
fn aes_ctr_long_test() -> Result<(), mochi_crypto::Error> {
    let key = hex!("603DEB1015CA71BE2B73AEF0857D77811F352C073B6108D72D9810A30914DFF4");
