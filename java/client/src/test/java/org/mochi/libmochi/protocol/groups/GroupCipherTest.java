...
public class GroupCipherTest {
  ...
  private static final MochiProtocolAddress SENDER_ADDRESS =
      new MochiProtocolAddress("+14150001111", 1);
  ...
  public void testEncryptNoSession() {
    ...
    GroupCipher aliceGroupCipher =
        new GroupCipher(aliceStore, new MochiProtocolAddress("+10002223333", 1));
    try {
