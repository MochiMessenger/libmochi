...
import org.mochi.libmochi.svr.DataMissingException;
import org.mochi.libmochi.svr.RestoreFailedException;
import org.mochi.libmochi.svr.SvrException;
...
public class Svr3Test {
  ...
  private final String ENCLAVE_SECRET = TestEnvironment.get("LIBMOCHI_TESTING_ENCLAVE_SECRET");
