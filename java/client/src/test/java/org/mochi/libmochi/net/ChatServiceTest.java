...
import org.mochi.libmochi.util.TestEnvironment;
...
public class ChatServiceTest {
  ...
  public void testConnectUnauth() throws Exception {
    ...
    final String PROXY_SERVER = TestEnvironment.get("LIBMOCHI_TESTING_PROXY_SERVER");
  ...
  public void testConnectUnauthThroughProxy() throws Exception {
    ...
    switch (proxyComponents.length) {
      ...
      case 2:
        ...
        break;
      default:
        throw new IllegalArgumentException("invalid LIBMOCHI_TESTING_PROXY_SERVER");
    }
  ...
  public void testInvalidProxyRejected() throws Exception {
    // The default TLS proxy config doesn't support staging, so we connect to production.
    final Network net = new Network(Network.Environment.PRODUCTION, USER_AGENT);
    assertThrows(IOException.class, () -> net.setProxy("mochifoundation.org", 0));
    assertThrows(IOException.class, () -> net.setProxy("mochifoundation.org", 100_000));
    assertThrows(IOException.class, () -> net.setProxy("mochifoundation.org", -1));
  }
}
