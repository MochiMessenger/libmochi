...
public class Network {
   ...
   *
   * <p>Refer to {@link org.mochi.libmochi.net.Svr3} for the detailed description.
   */
  ...
  /**
   * Try to load several libmochi classes asynchronously, using the same mechanism as native (Rust)
   * code.
   *
   * <p>This should only be called in tests, and can be used to ensure at test time that libmochi
  ...
  public static void checkClassesCanBeLoadedAsyncForTest() {
    ...
    final String[] classesToLoad = {
      "org.mochi.libmochi.net.CdsiLookupResponse$Entry",
      "org.mochi.libmochi.net.NetworkException",
      "org.mochi.libmochi.net.ChatServiceException",
