...
//! Rust implementation of the **[Mochi Protocol]** for asynchronous
...
//!
//! [Mochi Protocol]: https://mochi.org/
//! [X3DH]: https://mochi.org/docs/specifications/x3dh/
//! [Double Ratchet]: https://mochi.org/docs/specifications/doubleratchet/

#![warn(clippy::unwrap_used)]
#![deny(unsafe_code)]

// TODO(https://github.com/mochimessenger/libmochi/issues/285): it should be an aspiration to
...
pub use error::MochiProtocolError;
...
pub use protocol::{
    ...
    PreKeyMochiMessage, SenderKeyDistributionMessage, SenderKeyMessage, MochiMessage,
};
pub use ratchet::{
    initialize_alice_session_record, initialize_bob_session_record, AliceMochiProtocolParameters,
    BobMochiProtocolParameters,
};
...
pub use session_cipher::{
    message_decrypt, message_decrypt_prekey, message_decrypt_mochi, message_encrypt,
};
pub use state::{
...
pub use storage::{
    ...
    InMemSenderKeyStore, InMemSessionStore, InMemMochiProtocolStore, InMemSignedPreKeyStore,
