...
public class PreKeyBundle: NativeHandleOwner {
    override internal class func destroyNativeHandle(_ handle: OpaquePointer) -> MochiFfiErrorRef? {
        return mochi_pre_key_bundle_destroy(handle)
    }
        ...
        try withNativeHandles(prekey, signedPrekey, identityKey.publicKey) { prekeyHandle, signedPrekeyHandle, identityKeyHandle in
            try signedPrekeySignature.withUnsafeBorrowedBuffer { signedSignatureBuffer in
                try [].withUnsafeBorrowedBuffer { kyberSignatureBuffer in
                    try checkError(mochi_pre_key_bundle_new(
                        &result,
                        registrationId,
                        deviceId,
                        prekeyId,
        ...
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningInteger {
                    mochi_pre_key_bundle_get_registration_id($0, nativeHandle)
                }
            }
        }
    }
    ...
    public var deviceId: UInt32 {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningInteger {
                    mochi_pre_key_bundle_get_device_id($0, nativeHandle)
                }
            }
        }
    }
    ...
    public var signedPreKeyId: UInt32 {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningInteger {
                    mochi_pre_key_bundle_get_signed_pre_key_id($0, nativeHandle)
                }
            }
        }
    }
    ...
    public var preKeyId: UInt32? {
        let prekey_id = withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningInteger {
                    mochi_pre_key_bundle_get_pre_key_id($0, nativeHandle)
                }
            }
        }
        ...
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningOptionalNativeHandle {
                    mochi_pre_key_bundle_get_pre_key_public($0, nativeHandle)
                }
            }
        }
    }
        ...
        let pk: PublicKey = withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningNativeHandle {
                    mochi_pre_key_bundle_get_identity_key($0, nativeHandle)
                }
            }
        }
    ...
    public var signedPreKeyPublic: PublicKey {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningNativeHandle {
                    mochi_pre_key_bundle_get_signed_pre_key_public($0, nativeHandle)
                }
            }
        }
    }
        ...
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningArray {
                    mochi_pre_key_bundle_get_signed_pre_key_signature($0, nativeHandle)
                }
            }
        }
    }
    ...
    public var kyberPreKeyId: UInt32? {
        let prekey_id = withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningInteger {
                    mochi_pre_key_bundle_get_kyber_pre_key_id($0, nativeHandle)
                }
            }
        }
        return prekey_id == ~0 ? nil : prekey_id
    ...
    public var kyberPreKeyPublic: KEMPublicKey? {
        return withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningOptionalNativeHandle {
                    mochi_pre_key_bundle_get_kyber_pre_key_public($0, nativeHandle)
                }
            }
        }
    }
    ...
    public var kyberPreKeySignature: [UInt8]? {
        let result: [UInt8] = withNativeHandle { nativeHandle in
            failOnError {
                try invokeFnReturningArray {
                    mochi_pre_key_bundle_get_kyber_pre_key_signature($0, nativeHandle)
                }
            }
        }
