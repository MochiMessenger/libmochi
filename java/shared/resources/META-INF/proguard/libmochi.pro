...
-keepclasseswithmembernames,includedescriptorclasses class org.mochi.libmochi.** {
    native <methods>;
}

# Keep members that the Rust library accesses directly on a variety of classes.
-keepclassmembers class org.mochi.libmochi.** {
...
# via JNI.
-keepclassmembers,includedescriptorclasses class org.mochi.libmochi.** {
    @org.mochi.libmochi.internal.CalledFromNative *;
}
...
-keepclassmembers @org.mochi.libmochi.internal.CalledFromNative interface org.mochi.libmochi.** {
    *;
}
...
-keep @org.mochi.libmochi.internal.CalledFromNative class org.mochi.libmochi.**

# As a convenience, enums with @CalledFromNative keep all their values.
-keep @org.mochi.libmochi.internal.CalledFromNative enum org.mochi.libmochi.** {
    <fields>;
}

# Keep constructors for all our exceptions.
# (This could be more fine-grained but doesn't really have to be.)
-keep,includedescriptorclasses class org.mochi.libmochi.**.*Exception {
    <init>(...);
}
...
-keep class org.mochi.libmochi.protocol.MochiProtocolAddress
-keep class org.mochi.libmochi.protocol.message.* implements org.mochi.libmochi.protocol.message.CiphertextMessage
...
-keepnames interface org.mochi.libmochi.**.*Store { *; }

-keepnames enum org.mochi.libmochi.protocol.state.IdentityKeyStore$Direction { *; }
-keepnames class org.mochi.libmochi.**.*Record
