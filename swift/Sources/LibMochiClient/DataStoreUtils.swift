...
internal func withIdentityKeyStore<Result>(_ store: IdentityKeyStore, _ context: StoreContext, _ body: (UnsafePointer<MochiIdentityKeyStore>) throws -> Result) throws -> Result {
    ...
    func ffiShimIsTrustedIdentity(
        ...
        return storeContext.pointee.catchCallbackErrors { store, context in
            ...
            switch MochiDirection(raw_direction) {
            case MochiDirectionSending:
                direction = .sending
            case MochiDirectionReceiving:
                direction = .receiving
            default:
    ...
    return try rethrowCallbackErrors((store, context)) {
        var ffiStore = MochiIdentityKeyStore(
            ctx: $0,
...
internal func withPreKeyStore<Result>(_ store: PreKeyStore, _ context: StoreContext, _ body: (UnsafePointer<MochiPreKeyStore>) throws -> Result) throws -> Result {
...
internal func withSignedPreKeyStore<Result>(_ store: SignedPreKeyStore, _ context: StoreContext, _ body: (UnsafePointer<MochiSignedPreKeyStore>) throws -> Result) throws -> Result {
    ...
    return try rethrowCallbackErrors((store, context)) {
        var ffiStore = MochiSignedPreKeyStore(
            ctx: $0,
...
internal func withKyberPreKeyStore<Result>(_ store: KyberPreKeyStore, _ context: StoreContext, _ body: (UnsafePointer<MochiKyberPreKeyStore>) throws -> Result) throws -> Result {
    ...
    return try rethrowCallbackErrors((store, context)) {
        var ffiStore = MochiKyberPreKeyStore(
            ctx: $0,
...
internal func withSessionStore<Result>(_ store: SessionStore, _ context: StoreContext, _ body: (UnsafePointer<MochiSessionStore>) throws -> Result) throws -> Result {
    ...
    return try rethrowCallbackErrors((store, context)) {
        var ffiStore = MochiSessionStore(
            ctx: $0,
...
internal func withSenderKeyStore<Result>(_ store: SenderKeyStore, _ context: StoreContext, _ body: (UnsafePointer<MochiSenderKeyStore>) throws -> Result) rethrows -> Result {
    ...
    return try rethrowCallbackErrors((store, context)) {
        var ffiStore = MochiSenderKeyStore(
            ctx: $0,
